...
namespace llvm {
  namespace STM8ISD {
    enum NodeType : unsigned {
      ...
      /// STM8 conditional branches. Operand 0 is the chain operand, operand 1
  ...
  public:
    ...
    /// Ty1 to type Ty2. e.g. On stm8 it's free to truncate a i16 value in
    ...
    /// necessarily apply to truncate instructions. e.g. on stm8, all
